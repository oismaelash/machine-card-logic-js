...
//Função respomsavel por criar a conta
 function creatAccount(account) {
  // caso nao exista e o valor do active-card true? ele cria uma conta e armazena na variavel resultAccount
   if (resultAccount === null && account.account['active-card'] === true ) {
    ...
    //caso exista o valor do active-card true?  cria um objeto copia e adiciona as violações da lógica de negócios.
